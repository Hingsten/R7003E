...
typedef struct tag_LZATNKaowXRlwzpKcQ6wRE Encoder_arduino_LabB_ObserverAn;
...
typedef struct tag_pYcsb98J6JO1Ji7woCUjNC soMPU6050Gyro_LabB_ObserverAndC;
...
typedef struct tag_4eDVzK5FiryyCjvjjvrZGB codertarget_arduinobase_inter_a;
