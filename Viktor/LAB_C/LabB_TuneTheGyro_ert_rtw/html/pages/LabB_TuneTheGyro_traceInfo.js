function RTW_rtwnameSIDMap() {
	...
	this.rtwnameHashMap["<Root>/Gyroscope"] = {sid: "LabB_TuneTheGyro:578"};
	this.sidHashMap["LabB_TuneTheGyro:578"] = {rtwname: "<Root>/Gyroscope"};
	this.rtwnameHashMap["<Root>/Scope"] = {sid: "LabB_TuneTheGyro:577"};
	this.sidHashMap["LabB_TuneTheGyro:577"] = {rtwname: "<Root>/Scope"};
